          ...
          <div class="container">
            ...
            <div class="nav-collapse">
              <ul class="nav">
                ...
                <% if(usuario.getBuscarMateria() || usuario.getBuscarProfesores() || usuario.getBuscarSalon()) { %>
                <li class="dropdown">
              ...
              <ul class="nav pull-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="perfil.jsp"><i class="icon-pencil"></i> Cambiar Perfil</a></li>
					</ul>
				</li>
