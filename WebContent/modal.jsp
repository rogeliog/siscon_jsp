        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span4 offset5">
                  ...
                  <div class="modal hide fade" style="display:none;" id="myModal">
                    ...
                    <form action="inicio.html" class="well form-horizontal">
                    <fieldset>
                        <div class="control-group">
                          <label class="control-label" for="usuario">Usuario</label>
                          <div class="controls">
                  ...
                  <a class="btn btn-large btn-primary" data-toggle="modal" href="#myModal" >Iniciar Sesi&oacute;n</a>
